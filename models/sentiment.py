...
class SentimentModel(object):
    ...
    def __init__(self, vocab_size, hidden_size, dropout,
        ...
        self.saver = tf.train.Saver(tf.all_variables(), keep_checkpoint_every_n_hours=1)
    ...
    def initData(self, data, train_start_end_index, test_start_end_index):
        ...
        self.test_data = np.array_split(self.test_data, num_test_batches)
        self.test_targets = onehot[test_start_end_index[0]:test_start_end_index[1]][:test_cutoff]
        self.test_targets = np.array_split(self.test_targets, num_test_batches)
        self.test_sequence_lengths = sequence_lengths[test_start_end_index[0]:test_start_end_index[1]][:test_cutoff]
        self.test_sequence_lengths = np.array_split(self.test_sequence_lengths, num_test_batches)
